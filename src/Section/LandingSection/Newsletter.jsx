    ...
    <>
      <section className="my-32 max-sm:my-16 max-lg:my-20">
        ...
        <div className="container px-6 md:px-12">
          <div className="block rounded-lg px-6 py-12 max-sm:py-6 shadow-md bg-white dark:bg-darkBgPrimary md:py-16 md:px-12 mt-[-100px] max-sm:rounded-sm backdrop-blur-[30px]">
