...
const PreviewModal = ({ blogData, previewModal }) => {
  ...
  return (
    <div
      ref={previewModalref}
      className="absolute left-0 top-0  py-12 max-sm:pb-96 z-50   flex items-center transition-all ease-in-out duration-300  justify-center backdrop-blur-sm bg-Opacityblack "
